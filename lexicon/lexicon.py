...
🗃️ Тип кошелька: <code>{walletType}</code>''',
    'IsDigit': '''🔴 <b>ОШИБКА</b> 🔴
Не верное сообщение, не является числом или не попало в интервал от 1 до 1.7 - <code>{digit}</code>''',
...
walletsMenu: dict[str: str] = {
    'addWallet': addLexicon['add']
}

patternsMenu: dict[str: str] = {
    'addPattern': addLexicon['add']
}
